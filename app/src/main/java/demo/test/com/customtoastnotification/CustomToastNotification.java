package demo.test.com.customtoastnotification;
...
import demo.test.com.customtoastnotification.databinding.CustomToastNotificationBinding;


/**
 * Created by DauBV on 25/07/2017.
 */
...
public class CustomToastNotification extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        mBinding = DataBindingUtil
                .inflate(LayoutInflater.from(context), R.layout.custom_toast_notification, this, true);
